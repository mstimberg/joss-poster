...
\block[linewidth=0pt]{}{
    ...
    {\Huge{\href{https://joss.theoj.org}{\ttfamily joss.theoj.org}}}
  	\end{minipage}
\par\vspace{1em}
Presented by \textbf{Marcel Stimberg} (JOSS Topic Editor) at the \emph{Neuroscience Open Workshop 2023} (22--23 Nov 2023)
}
...
\block{Publication statistics}{
  ...
  \begin{tabular}{p{0.7\linewidth}@{\quad}cr}
    ...
    \href{http://dx.doi.org/10.21105/joss.01686}{Welcome to the Tidyverse} & 2019 & 7\,770 \\
    \href{http://dx.doi.org/10.21105/joss.00861}{UMAP: Uniform Manifold Approximation and Projection}
    & 2018 & 4\,055 \\
    \href{http://dx.doi.org/10.21105/joss.03021}{seaborn: statistical data visualization} & 2021 & 2\,047 \\
    \href{http://dx.doi.org/10.21105/joss.00024}{corner.py: Scatterplot matrices in Python} & 2016 & 1\,172 \\
